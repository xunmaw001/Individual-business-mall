...
public class ShangpinOrderView extends ShangpinOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		*/
		...
		//级联表 shangpin
			...
			* 是否特卖
			*/
			private Integer temaiTypes;
				/**
				* 是否特卖的值
				*/
				private String temaiValue;
			/**
			* 是否上架
			*/
	...
	public ShangpinOrderView(ShangpinOrderEntity shangpinOrderEntity) {
		try {
			...
			* 获取： 收货方式的值
			*/
			public String getShouhuoValue() {
				return shouhuoValue;
			}
			/**
			* 设置： 收货方式的值
			*/
			public void setShouhuoValue(String shouhuoValue) {
				this.shouhuoValue = shouhuoValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			...
			*/
			public void setShangpinOrderPaymentValue(String shangpinOrderPaymentValue) {
				...
				//级联表的get和set shangpin
					...
					* 获取： 是否特卖
					*/
					public Integer getTemaiTypes() {
						return temaiTypes;
					}
					/**
					* 设置： 是否特卖
					*/
					public void setTemaiTypes(Integer temaiTypes) {
						this.temaiTypes = temaiTypes;
					}
						...
						* 获取： 是否特卖的值
						*/
						public String getTemaiValue() {
							return temaiValue;
						}
						/**
						* 设置： 是否特卖的值
						*/
						public void setTemaiValue(String temaiValue) {
							this.temaiValue = temaiValue;
						}
					/**
					* 获取： 是否上架
					*/
