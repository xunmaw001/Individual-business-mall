                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../shangpin/detail.jsp?id='+item.shangpinId)">
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../shangpin/detail.jsp?id='+item.shangpinId)"><span>{{item.shangpinName}}</span></div>
...
<script>
    ...
    // 级联表的字段数据
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('shangpinCollection/list', 'get', param, function(res) {
