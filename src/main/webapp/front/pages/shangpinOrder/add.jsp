    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="shangpin.shangxiaValue" type="text" readonly="readonly" placeholder="是否上架" autocomplete="off" class="layui-input">
                </div>
            </div>
...
<!-- 唯一uuid -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <select name="shouhuoTypes" id="shouhuoTypes" lay-filter="shouhuoTypes">
                        <option v-for="item in shouhuoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                    </select>
                </div>
            </div>
...
//            data["shangpinOrderTypes"]= 3;
       ...
       function shouhuoTypesSelect() {
           //填充下拉框选项
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shouhuo_types", "GET", {}, (res) => {
               if(res.code == 0){
