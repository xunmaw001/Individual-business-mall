		...
		<div id="app">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="shangpinOldMoney" id="shangpinOldMoney"  lay-verify="required|double"   placeholder="商品原价" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">现价/积分</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="shangpinNewMoney" id="shangpinNewMoney"  lay-verify="required|double"   placeholder="现价/积分" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="temaiTypes" id="temaiTypes">
                                    <option v-for="item in temaiTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shangxiaTypes" id="shangxiaTypes">
                                    <option v-for="item in shangxiaTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
			   ...
			   function temaiTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=temai_types", "GET", {}, (res) => {
					   if(res.code == 0){
