            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuNewJifenStart" id="yonghuNewJifenStart"  lay-skin="double"   placeholder="现积分开始" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <div class="layui-input-inline" style="margin-top: -5px">
                              <input type="text" name="yonghuNewJifenEnd"   id="yonghuNewJifenEnd"    lay-skin="double|yonghuNewJifenEnd"   placeholder="现积分结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        form.verify({
            ...
            ,yonghuNewJifenEnd: function(value, item){ //value：表单的值、item：表单的DOM对象
                var yonghuNewJifenStart = $("#yonghuNewJifenStart").val();
                if(yonghuNewJifenStart != null && yonghuNewJifenStart != "" && yonghuNewJifenStart != "null"){
                    var number = parseInt(value)- parseInt(yonghuNewJifenStart);
                    if(number<0){
                        return '现积分的结束值不能小于开始值';
                    }
                }
            }
        ...
        function pageList() {
            ...
            if (jquery('#yonghuNewJifenStart').val() != null && jquery('#yonghuNewJifenStart').val() != "" && jquery('#yonghuNewJifenStart').val() != "null" ) {
                param['yonghuNewJifenStart'] = jquery('#yonghuNewJifenStart').val();
            }
            if (jquery('#yonghuNewJifenEnd').val() != null && jquery('#yonghuNewJifenEnd').val() != "" && jquery('#yonghuNewJifenEnd').val() != "null" ) {
                param['yonghuNewJifenEnd'] = jquery('#yonghuNewJifenEnd').val();
            }
