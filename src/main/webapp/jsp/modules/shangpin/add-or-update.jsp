                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpinTypesDiv">
                                        <label>商品类型</label>
                                        <select id="shangpinTypesSelect" name="shangpinTypes" class="form-control">
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 shangpinNewMoneyDiv">
                                        ...
                                        <input id="shangpinNewMoney" name="shangpinNewMoney" class="form-control"
                                               onchange="shangpinNewMoneyChickValue(this)" placeholder="现价/积分">
                                    </div>
                                    <div class="form-group col-md-6 shangpinClicknumDiv">
                                        <label>点击次数</label>
                                        <input id="shangpinClicknum" name="shangpinClicknum" class="form-control"
                                               onchange="shangpinClicknumChickValue(this)"  placeholder="点击次数">
                                    </div>

                                    <div class="form-group col-md-6 temaiTypesDiv">
                                        <label>是否特卖</label>
                                        <select id="temaiTypesSelect" name="temaiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 shangxiaTypesDiv">
                                        <label>是否上架</label>
                                        <select id="shangxiaTypesSelect" name="shangxiaTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 查询列表
        ...
        function temaiTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=temai_types", "GET", {}, (res) => {
                if(res.code == 0){
                    temaiTypesOptions = res.data.list;
                }
            });
        }
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationTemaitypesSelect(){
            var temaiTypesSelect = document.getElementById('temaiTypesSelect');
            if(temaiTypesSelect != null && temaiTypesOptions != null  && temaiTypesOptions.length > 0 ){
                for (var i = 0; i < temaiTypesOptions.length; i++) {
                    temaiTypesSelect.add(new Option(temaiTypesOptions[i].indexName,temaiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(temaiTypesSelect != null && temaiTypesOptions != null  && temaiTypesOptions.length > 0 ) {
            for (var i = 0; i < temaiTypesOptions.length; i++) {
                if (temaiTypesOptions[i].codeIndex == ruleForm.temaiTypes) {//下拉框value对比,如果一致就赋值汉字
                        temaiTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationTemaitypesSelect();
