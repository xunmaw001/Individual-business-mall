...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //是否特卖
            var temaiTypesCell = document.createElement('td');
            temaiTypesCell.innerHTML = item.temaiValue;
            row.appendChild(temaiTypesCell);
    ...
    //查询当前表搜索条件所有列表
        ...
        function submitPlusOrReduceShangpinKucunNumber() {
            ...
            if(hideflag == "+"){
                ...
                if(parseInt(thisShangpinKucunNumber) < parseInt(plusOrReduceShangpinKucunNumber)){
                    alert("库存不足，无法减少");
                    return false;
                }
                sumNumber =parseInt(thisShangpinKucunNumber) - parseInt(plusOrReduceShangpinKucunNumber);
