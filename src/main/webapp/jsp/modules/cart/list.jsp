                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        商品库存
                                        <div class="layui-input-inline">
                                            <input type="text" id="shangpinKucunNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="shangpinKucunNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="shangpinKucunNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="shangpinKucunNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        现积分
                                        <div class="layui-input-inline">
                                            <input type="text" id="yonghuNewJifenStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="yonghuNewJifenChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="yonghuNewJifenEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="yonghuNewJifenChickValue(this)"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
