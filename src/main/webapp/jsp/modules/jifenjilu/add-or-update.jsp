    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑积分记录</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑积分记录</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">积分记录信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 jifenjiluNameDiv">
                                        <label>原因</label>
                                        <input id="jifenjiluName" name="jifenjiluName" class="form-control"
                                               placeholder="原因">
                                    </div>
                                    <div class="form-group col-md-6 jifenjiluNumberDiv">
                                        <label>积分数量</label>
                                        <input id="jifenjiluNumber" name="jifenjiluNumber" class="form-control"
                                               onchange="jifenjiluNumberChickValue(this)" placeholder="积分数量">
                                    </div>
                                    <div class="form-group col-md-6 jifenTypesDiv">
                                        <label>类型</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("jifenjilu/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addjifenjilu');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function jifenjiluNumberChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                // jifenjiluName: "required",
                // jifenjiluNumber: "required",
                // jifenTypes: "required",
            },
            messages: {
                yonghuId: "用户姓名不能为空",
                // jifenjiluName: "原因不能为空",
                // jifenjiluNumber: "积分数量不能为空",
                // jifenTypes: "类型不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addjifenjilu = window.sessionStorage.getItem("addjifenjilu");
        if (addjifenjilu != null && addjifenjilu != "" && addjifenjilu != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("jifenjilu/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jifenjiluName").val(ruleForm.jifenjiluName);
        $("#jifenjiluNumber").val(ruleForm.jifenjiluNumber);
