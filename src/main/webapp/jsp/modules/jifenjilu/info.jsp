            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">积分记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jifenjiluName" name="jifenjiluName" class="form-control"
                                               v-model="ruleForm.jifenjiluName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jifenjiluNumber" name="jifenjiluNumber" class="form-control"
                                               v-model="ruleForm.jifenjiluNumber" readonly>
                                    </div>
