                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>商家</label>
                                            <input id="shangjiaId" name="shangjiaId" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shangxiaValue" name="shangxiaValue" class="form-control"
                                               v-model="ruleForm.shangxiaValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input id="shangpinOrderValue" name="shangpinOrderValue" class="form-control"
                                           v-model="ruleForm.shangpinOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>收货方式</label>
                                    <input id="shouhuoValue" name="shouhuoValue" class="form-control"
                                           v-model="ruleForm.shouhuoValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input id="shangpinOrderPaymentValue" name="shangpinOrderPaymentValue" class="form-control"
