    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑客服聊天</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">客服聊天管理</li>
                        <li class="breadcrumb-item active">客服聊天登记</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">客服聊天信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>问题</label>
                                        <input id="chatIssue" name="chatIssue" class="form-control"
                                               v-model="ruleForm.chatIssue" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>问题时间</label>
                                        <input id="issueTime" name="issueTime" class="form-control"
                                               v-model="ruleForm.issueTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>回复</label>
                                        <input id="chatReply" name="chatReply" class="form-control"
                                               v-model="ruleForm.chatReply" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>数据类型</label>
                                    <input id="chatValue" name="chatValue" class="form-control"
                                           v-model="ruleForm.chatValue" readonly>
                                </div>
...
<script>
    ...
    function exit() {
        ...
        window.sessionStorage.removeItem('addchat');
